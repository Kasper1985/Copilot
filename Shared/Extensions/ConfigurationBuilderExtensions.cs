...
public static class ConfigurationBuilderExtensions
{
    ...
    public static void AddKernelMemoryConfigurationSources(this IConfigurationBuilder builder, bool useAppSettingsFiles = true, bool useEnvVars = true, bool useSecretManager = true,
        string? settingsDirectory = null)
    {
        ...
        if (useSecretManager)
        {
            // GetEntryAssembly method can return null if the library is loaded from an unmanaged application, in which case UserSecrets are not supported.
